...
class TemplateSupportPlugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>) = with(kotlinCompilation.target.project) {
        plugins.hasPlugin(TemplateSupportPlugin::class.java) && getExtension().enabled
    }
    ...
    private fun Project.getExtension(): TemplatePluginExtension =
        extensions.findByType(TemplatePluginExtension::class.java) ?: TemplatePluginExtension()
}
